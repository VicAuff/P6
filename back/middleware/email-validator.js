...
module.exports = (req, res, next) => {
  // Vérifie si l'adresse e-mail dans la requête est valide en utilisant la fonction validate() de la bibliothèque email-validator
  if (!emailValidator.validate(req.body.email)) {
    // Si l'adresse e-mail n'est pas valide, envoie une réponse avec un code d'erreur 400 (Bad Request) et un message d'erreur
    res
      .status(400)
