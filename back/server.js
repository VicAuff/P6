...
const errorHandler = (error) => {
  ...
  const bind = typeof address === "string" ? "pipe " + address : "port " + port; // Détermine le type de connexion (pipe ou port) en fonction de l'adresse du serveur
  switch (error.code) {
    case "EACCES":
      console.error(bind + " requires elevated privileges."); // Affiche un message d'erreur si les privilèges sont insuffisants
